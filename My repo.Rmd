...
6. Pull from the main branch with blue arrow.
7. then hit COMMIT button.
8. Then hit the green arrow to push new stuff

9. If committing to branch, need to commit, then push into the branch: make sure to select BrANCH you want when in the commit window.
